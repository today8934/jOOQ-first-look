...
public class CustomerDao extends DAOImpl<CustomerRecord, Customer, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfCustomerId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByCustomerId(UInteger... values) {
     ...
     */
    public Customer fetchOneByCustomerId(UInteger value) {
     ...
     * Fetch a unique record that has <code>customer_id = value</code>
     */
    public Optional<Customer> fetchOptionalByCustomerId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfStoreId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByStoreId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfFirstName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Customer> fetchByFirstName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfLastName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Customer> fetchByLastName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfEmail(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Customer> fetchByEmail(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Customer> fetchByAddressId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfActive(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<Customer> fetchByActive(Byte... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfCreateDate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Customer> fetchByCreateDate(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Customer> fetchByLastUpdate(LocalDateTime... values) {
