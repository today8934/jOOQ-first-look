...
public class LanguageDao extends DAOImpl<LanguageRecord, Language, Long> {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfLanguageId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Language> fetchByLanguageId(Long... values) {
     ...
     */
    public Language fetchOneByLanguageId(Long value) {
     ...
     * Fetch a unique record that has <code>language_id = value</code>
     */
    public Optional<Language> fetchOptionalByLanguageId(Long value) {
