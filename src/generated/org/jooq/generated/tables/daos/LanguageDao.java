...
public class LanguageDao extends DAOImpl<LanguageRecord, Language, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Language> fetchByLanguageId(UInteger... values) {
     ...
     */
    public Language fetchOneByLanguageId(UInteger value) {
     ...
     * Fetch a unique record that has <code>language_id = value</code>
     */
    public Optional<Language> fetchOptionalByLanguageId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Language> fetchByName(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Language> fetchByLastUpdate(LocalDateTime... values) {
