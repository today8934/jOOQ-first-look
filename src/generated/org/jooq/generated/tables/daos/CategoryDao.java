...
public class CategoryDao extends DAOImpl<CategoryRecord, Category, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Category> fetchRangeOfCategoryId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Category> fetchByCategoryId(UInteger... values) {
     ...
     */
    public Category fetchOneByCategoryId(UInteger value) {
     ...
     * Fetch a unique record that has <code>category_id = value</code>
     */
    public Optional<Category> fetchOptionalByCategoryId(UInteger value) {
