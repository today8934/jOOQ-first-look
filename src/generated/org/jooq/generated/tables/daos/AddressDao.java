...
public class AddressDao extends DAOImpl<AddressRecord, Address, Long> {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfAddressId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Address> fetchByAddressId(Long... values) {
     ...
     */
    public Address fetchOneByAddressId(Long value) {
     ...
     * Fetch a unique record that has <code>address_id = value</code>
     */
    public Optional<Address> fetchOptionalByAddressId(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<Address> fetchRangeOfCityId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Address> fetchByCityId(Long... values) {
