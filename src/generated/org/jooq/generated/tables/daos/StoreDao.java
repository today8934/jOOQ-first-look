...
public class StoreDao extends DAOImpl<StoreRecord, Store, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfStoreId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Store> fetchByStoreId(UInteger... values) {
     ...
     */
    public Store fetchOneByStoreId(UInteger value) {
     ...
     * Fetch a unique record that has <code>store_id = value</code>
     */
    public Optional<Store> fetchOptionalByStoreId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfManagerStaffId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Store> fetchByManagerStaffId(UInteger... values) {
     ...
     */
    public Store fetchOneByManagerStaffId(UInteger value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<Store> fetchOptionalByManagerStaffId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfAddressId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Store> fetchByAddressId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Store> fetchByLastUpdate(LocalDateTime... values) {
