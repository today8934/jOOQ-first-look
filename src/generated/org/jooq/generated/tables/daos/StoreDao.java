...
public class StoreDao extends DAOImpl<StoreRecord, Store, Long> {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfStoreId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Store> fetchByStoreId(Long... values) {
     ...
     */
    public Store fetchOneByStoreId(Long value) {
     ...
     * Fetch a unique record that has <code>store_id = value</code>
     */
    public Optional<Store> fetchOptionalByStoreId(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfManagerStaffId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Store> fetchByManagerStaffId(Long... values) {
     ...
     */
    public Store fetchOneByManagerStaffId(Long value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<Store> fetchOptionalByManagerStaffId(Long value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfAddressId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Store> fetchByAddressId(Long... values) {
