...
public class FilmDao extends DAOImpl<FilmRecord, Film, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfFilmId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByFilmId(UInteger... values) {
     ...
     */
    public Film fetchOneByFilmId(UInteger value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<Film> fetchOptionalByFilmId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfTitle(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Film> fetchByTitle(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Film> fetchByDescription(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfReleaseYear(Year lowerInclusive, Year upperInclusive) {
     ...
     */
    public List<Film> fetchByReleaseYear(Year... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByLanguageId(UInteger... values) {
     ...
     */
    public List<Film> fetchRangeOfOriginalLanguageId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Film> fetchByOriginalLanguageId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfRentalDuration(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Film> fetchByRentalDuration(UByte... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfRentalRate(BigDecimal lowerInclusive, BigDecimal upperInclusive) {
     ...
     */
    public List<Film> fetchByRentalRate(BigDecimal... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfLength(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Film> fetchByLength(UShort... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfReplacementCost(BigDecimal lowerInclusive, BigDecimal upperInclusive) {
     ...
     */
    public List<Film> fetchByReplacementCost(BigDecimal... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfRating(FilmRating lowerInclusive, FilmRating upperInclusive) {
     ...
     */
    public List<Film> fetchByRating(FilmRating... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfSpecialFeatures(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Film> fetchBySpecialFeatures(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Film> fetchByLastUpdate(LocalDateTime... values) {
