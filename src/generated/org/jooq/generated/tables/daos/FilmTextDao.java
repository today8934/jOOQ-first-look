...
public class FilmTextDao extends DAOImpl<FilmTextRecord, FilmText, Integer> {
     ...
     * upperInclusive</code>
     */
    public List<FilmText> fetchRangeOfFilmId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<FilmText> fetchByFilmId(Integer... values) {
     ...
     */
    public FilmText fetchOneByFilmId(Integer value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<FilmText> fetchOptionalByFilmId(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<FilmText> fetchRangeOfTitle(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<FilmText> fetchByTitle(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmText> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<FilmText> fetchByDescription(String... values) {
