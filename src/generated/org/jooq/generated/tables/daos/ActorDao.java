...
public class ActorDao extends DAOImpl<ActorRecord, Actor, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Actor> fetchRangeOfActorId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Actor> fetchByActorId(UInteger... values) {
     ...
     */
    public Actor fetchOneByActorId(UInteger value) {
     ...
     * Fetch a unique record that has <code>actor_id = value</code>
     */
    public Optional<Actor> fetchOptionalByActorId(UInteger value) {
