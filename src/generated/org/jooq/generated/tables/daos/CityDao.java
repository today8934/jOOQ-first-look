...
public class CityDao extends DAOImpl<CityRecord, City, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<City> fetchRangeOfCityId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<City> fetchByCityId(UInteger... values) {
     ...
     */
    public City fetchOneByCityId(UInteger value) {
     ...
     * Fetch a unique record that has <code>city_id = value</code>
     */
    public Optional<City> fetchOptionalByCityId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<City> fetchRangeOfCountryId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<City> fetchByCountryId(UInteger... values) {
