...
public class FilmActorDao extends DAOImpl<FilmActorRecord, FilmActor, Record2<UInteger, UInteger>> {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfActorId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByActorId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfFilmId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByFilmId(UInteger... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByLastUpdate(LocalDateTime... values) {
