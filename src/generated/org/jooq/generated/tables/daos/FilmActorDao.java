...
public class FilmActorDao extends DAOImpl<FilmActorRecord, FilmActor, Record2<Long, Long>> {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfActorId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByActorId(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmActor> fetchRangeOfFilmId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<FilmActor> fetchByFilmId(Long... values) {
