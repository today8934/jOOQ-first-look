...
public class CountryDao extends DAOImpl<CountryRecord, Country, UInteger> {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfCountryId(UInteger lowerInclusive, UInteger upperInclusive) {
     ...
     */
    public List<Country> fetchByCountryId(UInteger... values) {
     ...
     */
    public Country fetchOneByCountryId(UInteger value) {
     ...
     * Fetch a unique record that has <code>country_id = value</code>
     */
    public Optional<Country> fetchOptionalByCountryId(UInteger value) {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfCountry(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<Country> fetchByCountry(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfLastUpdate(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<Country> fetchByLastUpdate(LocalDateTime... values) {
