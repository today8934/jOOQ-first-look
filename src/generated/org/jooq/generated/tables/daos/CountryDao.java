...
public class CountryDao extends DAOImpl<CountryRecord, Country, Long> {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfCountryId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<Country> fetchByCountryId(Long... values) {
     ...
     */
    public Country fetchOneByCountryId(Long value) {
     ...
     * Fetch a unique record that has <code>country_id = value</code>
     */
    public Optional<Country> fetchOptionalByCountryId(Long value) {
