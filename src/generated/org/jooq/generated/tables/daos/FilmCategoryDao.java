...
public class FilmCategoryDao extends DAOImpl<FilmCategoryRecord, FilmCategory, Record2<Long, Long>> {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfFilmId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByFilmId(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfCategoryId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByCategoryId(Long... values) {
